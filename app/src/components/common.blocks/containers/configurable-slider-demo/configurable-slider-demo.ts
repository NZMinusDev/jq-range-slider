...
} from '@common.blocks/containers/events-logger/events-logger';
import '@common.blocks/containers/events-logger/events-logger';
import type {
  SliderConfigCustomEvents,
  SliderConfigElementWithComponent,
} from '@common.blocks/containers/slider-config/slider-config';
import '@common.blocks/containers/slider-config/slider-config';
